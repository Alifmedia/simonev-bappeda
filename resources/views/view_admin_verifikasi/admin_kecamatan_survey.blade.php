    ...
    <div class="container mt-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('admin.kecamatan.survey.save', $data->id) }}" 
                method="post">
            @csrf
            <div class="row justify-content-center">
              <div class="col-11">
                <h3 class="card-title"><center>INDIKATOR-INDIKATOR PENILAIAN</center></h3>
                <hr>
                <br>
                ...
                @foreach ($data->soal as $key => $value)
                  <div class="form-group">
                    ...
                    <select class="form-control{{$errors->has('jawaban')?'is-invalid':''}}"         name="jawaban[{{$key}}]" 
                         required>
                      ...
                      <option value="{{ $jawaban->id }}" {{ count($value->jawabanSoalKecamatan) && $value->jawabanSoalKecamatan[0]['jawaban_id'] == $jawaban->id ? 'selected' : '' }}>{{ $jawaban->jawaban }}
                      </option>
                  ...
                  <input type="file" name="dokumen" class="custom-file-input" id="doc-upload" accept="file/*">
                   ...
                   <div class="col-md-4">
                    ...
                    <span>
                      <strong>DOKUMEN PENDUKUNG ADALAH:</strong>
                    </span>
                  </div>
