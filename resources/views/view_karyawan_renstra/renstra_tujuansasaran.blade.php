...
@section('main-content')
  ...
  <div id="data">
    ...
    <form id="delete-form" action="{{ route('karyawan_renstra.tujuansasaran.delete') }}" method="POST">
      @csrf
     ...
     <button type="submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;
       ...
       <a class="btn btn-primary" href="{{ route('karyawan_renstra.tujuansasaran.create') }}">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                @foreach ($value->tujuan as $key => $valu)
                    ...
                    <a class="btn btn-primary" href="{{ route('karyawan_renstra.tujuansasaran.edit', 
                                                              [$valu->renstra->id, 
                                                               $valu->id
                                                              ]
                                                              ) 
    ...
    <form id="delete-form" action="{{ route('karyawan_renstra.sasaran.delete') }}" method="POST">
      @csrf
              ...
              <tbody>
                ...
                @foreach ($value->indikatortujuan as $key => $valu)
                 ...
                 @foreach ($valu->renssasar as $key => $val)
                    ...
                    <td  align="margin-right"><font size="1"> 
                    <a class="btn btn-primary" href="{{ route('karyawan_renstra.sasaran.edit', 
                                                              [
                                                               $valu->id, 
                                                               $val->id
                                                               ]
