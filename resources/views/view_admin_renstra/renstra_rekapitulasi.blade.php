@extends('view_admin_renstra.renstra')
...
<center>
      <div class="filter"   >
        ...
        <div class="filter__input__sub" >
           ...
           <div class="form-group">
            ...
            <select class="form-control col-sm-6" id="filter5" name="periode" {{ count($filter['hal']) > 0 ? '' : 'disabled' }}>
          ...
          <!--  <div class="form-group">
            ...
            <select class="form-control col-sm-6" id="filter6" name="unsur" {{ count($filter['unsur']) > 0 ? '' : 'disabled' }}>
              <option value="0">Semua</option>
 ...
 -->
    ...
    {{-- Table --}}
    <br>
    <form id="delete-form" action="{{ route('admin.renstra.rekapitulasi') }}" method="POST">
      @csrf
