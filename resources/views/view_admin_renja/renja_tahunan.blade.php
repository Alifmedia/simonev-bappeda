                         ...
                         <td><font size="1">{{ $value->kemukiman->kecamatan->kabupaten->id }}</font></td>
                          ...
                          <td><font size="1">{{ $va->gampong->nama }}</font></td>
                                  ...
                                  @foreach ($va->indikatorrenssasarprogkeg as $key => $valido)
                                   <td><font size="1">{{ $valido->indikatorrenssasarprogkeg_indikator }}</font></td>
                                   <td><font size="1">{{ $valido->indikatorrenssasarprogkeg_target1 }}
                                                      {{ $valido->indikatorrenssasarprogkeg_satuan }}</font></td>
                                   <td><font size="1">{{ $valido->indikatorrenssasarprogkeg_targetkeuangan1 }}</font></td>
                                   <td><font size="1">   -</font> </td>  
                                   <td><font size="1"></font></td>
                                    <td><font size="1">  </td>
                                <td><font size="1"> </font> </td>  
