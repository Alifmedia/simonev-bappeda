            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr bgcolor="yellow"  >
                  ...
                  <td scope="col" ><font size="1.5"><strong>SATUAN</strong></font></td>
                ...
                @foreach ($data as $key => $value)
                  <!-- <tr bgcolor="#aaa">
                   ...
                   <td scope="col" ><font size="1.5"><strong></strong></font></td>
                    ...
                    <td><font size="1">{{ $valus->renssasarprog_indikator }}</font></td>
                    ...
                    <td scope="col" ><font size="1.5"><strong></strong></font></td>
                     <td scope="col" ><font size="1.5"><strong></strong></font></td>
                      ...
                      <td><font size="1">{{ $val->renssasarprogkeg_indikator }}</font></td>
                    ...
                    @foreach ($vali->renssasarprogkegsubkeg as $key => $valo)
                      ...
                      <td><font size="1.5"><strong></strong></font></td>
                     ...
                     <a class="btn btn-primary" 
                          href="{{ route('supervisor_dpa.dpa.create',
                                          [$valo->id,
