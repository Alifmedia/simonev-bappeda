              ...
              <tbody>
                @foreach ($data as $key => $value)
                  <tr>
                    ...
                    <td>{{ $value->jurnalKonsultasi->last()['updated_at'] }}</td>
                    <td>{{ $value->umum['Nama'] }}</td>
                    <td>{{ $value->umum['sektoral']['nama'] }}</td>
                          <td>
     ...
     aria-hidden="true">
      ...
      <div class="modal-dialog" 
        ...
        <div class="modal-content">
          ...
          <h4 align="center">KOMORBID-KOMPLIKASI</h4>
          <ol class="pl-4" >
         ...
         <input value=" TINGGI BADAN">
          ...
          <p class="font-weight-bold m-0">INSTRUKSI_MEDIS</p>
            <div class="card" >
              <div class="card-body" >
          <p>{{ $value->terekap['instruksi_komplikasi'] }}</p>
        </div>
      </div>
