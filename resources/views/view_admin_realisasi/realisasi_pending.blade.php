              ...
              <tbody>
                @foreach ($data as $key => $value)
                  <tr>
                    ...
                    <td><font size="1">{{ $value->item->konsultasi->renssasarprogkegsubkeg->dusun->dusun_kode }}</font></td>
                    <td><font size="1">{{ $value->item->konsultasi->renssasarprogkegsubkeg->dusun->nama }}</font></td>
                    <td><font size="1">{{ $value->item->konsultasi->renssasarprogkegsubkeg->indikatorrenssasarprogkeg->renssasarprogkeg->indikatorrenssasarprog->renssasarprog->indikatorrenssasar->renssasar->indikatortujuan->tujuan->renstra->sektoral->nama }}</font></td>
                    ...
                    <td>
                      <a href="{{ route('admin.realisasi.peprekomorbidan', $value->id) }}">
                        <i class="fa fa-times-circle text-danger" aria-hidden="true"></i>
                      </a>
                    </td>

                      <td>
                      <a href="{{ route('admin.realisasi.penormalan', $value->id) }}">
