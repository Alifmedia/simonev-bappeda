...
@section('main-content')
  <div id="data">
    ...
    <form id="search-form" action="{{ route('superadmin.pengguna.umum') }}" method="get">
      <!-- <div class="search">
      ...
      <div class="filter">
        <div class="filter__input__sub">
          ...
          <div class="form-group">
            <label for="filter1">OPD</label>
            <select class="form-control" id="filter1" name="sektoral">
    ...
    {{-- Table --}}
    <br>
    <form id="delete-form" action="{{ route('superadmin.pengguna.umum.delete') }}" method="POST">
      @csrf
      <button type="submit" class="btn btn-danger">
        <i class="fa fa-trash" aria-hidden="true"></i>&nbsp;
        Hapus
      </button>
      <a class="btn btn-primary" href="{{ route('superadmin.tambahUmum') }}">
