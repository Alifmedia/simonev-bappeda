...
@section('content')
  <div id="admin-add">
    <div class="nav-tabs-flat">
      <a href="{{ route('superadmin.pengguna.supervisor') }}">
    ...
    <div class="container mt-4">
      ...
      <div class="card">
        <div class="card-body">
          <h3 class="card-title" align="center">TAMBAH SUPERVISOR</h3>
          <form class="" action="{{ route('superadmin.simpanSupervisor') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
