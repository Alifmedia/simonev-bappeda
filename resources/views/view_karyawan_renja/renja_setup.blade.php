     ...
     <div class="search">
      ...
      <div class="form-group" >
        ...
        <div class="filter__input__sub" align="margin-right">  
           ...
           <div class="form-group">
            <label for="filter5" class="col-sm-0"><h6>SUBKEGIATAN</h6></label>
           ...
           <div class="form-group" >
            <label  for="filter6" class="col-sm-0">BARIS</label>
            <select class="form-control col-sm-6-sm" id="filter6" name="pagination">
              ...
              <tbody>
                ...
                @foreach ($data as $key => $value)
                  <tr>
                    ...
                    <td><font size="1">{{ $value->dusun_kode }}</font></td> 
                    <td><font size="1">{{ $value->gampong->nama }}</font></td>
                    <td><font size="1">{{ $value->nama }}</font></td>
                    <td>
                      <a class="btn btn-primary" 
                          href="{{ route('karyawan_renja.subkegiatan.create',
                                          [ $value->id, 
                                            $value->gampong->kemukiman->id, 
                                            $value->gampong_kode,       
                                            $value->nama   
                                          ]
                                         ) 
