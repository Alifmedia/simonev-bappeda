...
@section('main-content')
  <div id="data">
    ...
    <form id="search-form" action="{{ route('superadmin.opd.kantor') }}" method="get">
      <!-- <div class="search">
    ...
    {{-- Table --}}
    <br>
    <form id="delete-form" action="{{ route('superadmin.opd.kantor.delete') }}" method="POST">
      @csrf
      <button type="submit" class="btn btn-danger">
        <i class="fa fa-trash" aria-hidden="true"></i>&nbsp;
        Hapus
      </button>
      <a class="btn btn-primary" href="{{ route('superadmin.tambahKantor') }}">
