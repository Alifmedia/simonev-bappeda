...
@section('content')
  <div id="admin-add">
    <div class="nav-tabs-flat">
      <a href="{{ route('superadmin.opd.dinas') }}">
    ...
    <div class="container mt-4">
      ...
      <div class="card">
        <div class="card-body">
          <h3 class="card-title" align="center">TAMBAH DINAS</h3>
          <form class="" action="{{ route('superadmin.simpanDinas') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
