...
@section('content')
  <div id="pengguna">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
       ...
       <li class="nav-item">
        <a class="nav-link" href="{{ route('karyawan_matrix.karyawan_matrix') }}">MATRIX RFK</a>
        <h3></h3>
      </li>


        <li class="nav-item">
        <a class="nav-link" href="{{ route('karyawan_matrix.karyawan_matrix_renja') }}">MATRIX RENJA</a>
        <h3></h3>
      </li>
