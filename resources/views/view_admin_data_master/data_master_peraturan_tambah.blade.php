...
<div id="akomodasi-add">
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Tambah Peraturan</h3>
                <form action="{{ route('admin.master.peraturan.tambah') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <select class="custom-select" name="jenis">
                                  ...
                                  <option value="{{ $value->id }}" {{ $value->id == old('jenis') ? 'selected' : '' }}>{{ $value->nama }}</option>
                                  @endforeach
                              </select>
                          </div>
                          <div class="form-group">
                              ...
                              <select class="custom-select" name="perihal">
                                  ...
                                  <option value="{{ $value->id }}" {{ $value->id == old('perihal') ? 'selected' : '' }}>{{ $value->nama }}</option>
                                  @endforeach
                              </select>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="date" class="form-control date-picker" name="tanggal_pengesahan" value="{{ old('tanggal_pengesahan') }}" placeholder="Tangga Pengesahan">
                          </div>
                          <div class="form-group">
                              <label>Dokumen</label>
