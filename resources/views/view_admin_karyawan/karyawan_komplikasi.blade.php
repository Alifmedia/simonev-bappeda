          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                @if($value->latestRM->jurnalKonsultasiLatest->status_konsultasi_id == 5)
                  <tr>
    ...
    <div class="modal fade" id="detail-modal-{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="detailModalTitle" aria-hidden="true" align="center">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <h4 align="center">KOMPLIKASI-KOMORBID</h4>
          <ol class="pl-4" >
         ...
         <input value=" TINGGI BADAN">
          ...
          <p>{{ $value->latestRM->terekap['instruksi_komplikasi'] }}</p>
           </div>
          </div>
          ...
          <p>{{ $value->latestRM->terekap['waktu_rm_lagi'] }}</p>
             </div>
          </div>
