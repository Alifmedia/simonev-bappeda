          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                @if($value->latestRM->jurnalKonsultasiLatest->status_konsultasi_id == 3)
    ...
    <div class="modal fade" id="detail-modal-{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="detailModalTitle" aria-hidden="true" align="center">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <h4 align="center">PREKOMORBID</h4>
          <ol class="pl-4" >
         ...
         <h4 align="center">HASIL REKAM MEDIS</h4>
          ...
          <div class="card" >
           <div class="card-body" >
          <p>{{ $value->latestRM->terverivikasi['instruksi_prekomorbid'] }}</p>
          </div>
      </div>
          ...
          <p>{{ $value->latestRM->terverivikasi['waktu_rm_lagi'] }}</p>
