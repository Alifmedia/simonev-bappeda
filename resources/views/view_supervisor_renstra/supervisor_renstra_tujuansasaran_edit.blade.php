...
@section('content')
  <div id="akomodasi-add">
    <div class="nav-tabs-flat">
      <a href="{{ route('supervisor.renstra.tujuansasaran') }}">
    ...
    <div class="container mt-4" align="center">
      ...
      <form action="{{ route('supervisor_renstra.tujuansasaran.update',[$renstra_id, $tujuan_id]) }}" method="post" enctype="multipart/form-data">
            @csrf
       <br>
