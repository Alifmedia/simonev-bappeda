            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr bgcolor="yellow"  >
                  ...
                  <td scope="col" ><font size="1.5"><strong>BELANJA</strong></font></td>
               </tr>
                @foreach ($data as $key => $value)
                  <!-- <tr bgcolor="#aaa">
                   ...
                   <td scope="col" ><font size="1.5"><strong></strong></font></td>
                    ...
                    @foreach ($valus->indikatorrenssasarprog as $key => $valud)
                    <td><font size="1">{{ $valud->indikatorrenssasarprog_indikator }}</font></td>
                    <td><font size="1"></font></td>
                    <td scope="col" ><font size="1.5"><strong>{{ $valud->indikatorrenssasarprog_tahun1 }}</strong></font></td>
                    <td scope="col" ><font size="1.5"><strong>{{ $valud->indikatorrenssasarprog_target1 }}</strong></font></td>
                    <td scope="col" ><font size="1.5"><strong></strong></font></td>
                    <td scope="col" ><font size="1.5"><strong></strong></font></td>
                      ...
                      @foreach ($valud->renssasarprogkeg as $key => $val)
                      ...
                      <td><font size="1">{{ $val->gampong['nama'] }}</font></td>
                       ...
                       @foreach ($val->indikatorrenssasarprogkeg as $key => $vali)
                      <td><font size="1">{{ $vali->indikatorrenssasarprogkeg_indikator }}</font></td>
                      <td><font size="1"></font></td>
                      <td><font size="1">{{ $vali->indikatorrenssasarprogkeg_nilaiawal }}</font></td>
                      <td scope="col" ><font size="1.5"><strong></strong></font></td>
                       <td scope="col" ><font size="1.5"><strong></strong></font></td>
                      <td scope="col" ><font size="1.5"><strong></strong></font></td>
                    ...
                    @foreach ($vali->renssasarprogkegsubkeg as $key => $valo)
                      ...
                      <td><font size="1">{{ $valo->renssasarprogkegsubkeg_targetkinerja }}</font></td>
                      <td><font size="1">{{ $valo->renssasarprogkegsubkeg_paguindikatif }}</font></td>                   
                      <td><font size="1">{{ $valo->bagian->nama }}</font></td>
                      <td>
                     <a class="btn btn-primary" 
                          href="{{ route('karyawan_dpa.dpa.create',
                                          [$valo->id,
                                           $valo->dusun->dusun_kode, 
                                           $valo->dusun->nama
                                          ]
                                         ) 
                                  }}">
