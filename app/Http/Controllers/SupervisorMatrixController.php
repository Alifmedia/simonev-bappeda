...
class SupervisorMatrixController extends Controller
{
    ...
    public function matrix(Request $req)
    {
      ...
      return view('view_supervisor_matrix.supervisor_matrix')->with('filter', $filter)
                                                      ->with('data', $data);
    }
...
return view('view_supervisor_matrix.supervisor_matrix_renja')->with('filter', $filter)
