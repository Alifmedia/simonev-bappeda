...
class KaryawanDpaController extends Controller
{
...
public function renja(Request $req)
    {
      ...
      return view('view_karyawan_dpa.dpa_renja')->with('filter', $filter)
                                                      ->with('data', $data);
    }
...
public function setuju(Request $req)
    ...
    // }
      ...
      return view('view_karyawan_dpa.dpa_setuju')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
 ...
 //                       )->get();
  ...
  $data = Renssasarprog::whereHas('indikatorrenssasar.renssasar.indikatortujuan.tujuan.renstra.sektoral.umumsektoral',
    ...
    // }
      ...
      return view('view_karyawan_dpa.dpa_rincian')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
    ...
    // }
      ...
      return view('view_karyawan_dpa.dpa_rekapitulasi')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
     ...
     public function createDPA(Request $req, $id, $dusun_kode, $nama)
    {
     ...
     return view('view_karyawan_dpa.dpa_add')->with('id', $id)
   ...
   //   $data->save();
      ...
      return redirect()->route('karyawan.dpa.setuju')
  ...
  //PENGEDITAN REKAM MEDIK
    ...
    //  $data->pukul_konsultasi   = Carbon::parse($jurnalKonsultasi['waktu'])->format('H:i');
      ...
      return view('view_karyawan_dpa.dpa_edit')->with('data', $data)
                                            ->with('hal', $hal)
                                            ->with('unsur', $unsur)
                                            ->with('sektoral', $sektoral)
                                            ->with('bagian', $bagian);
    ...
    public function deleteDPA(Request $req)
    {
     ...
     else
     {
      ...
      return redirect()->route('karyawan_dpa.dpa')
