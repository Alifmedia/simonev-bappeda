...
class SupervisorRenstraController extends Controller
{
    ...
    public function tujuansasaran(Request $req)
    {
      ...
      $data = Renstra::with(['sektoral.umumsektoral'=>function($query)
                                         {
      ...
      $data_tujuan = Tujuan::with(['renstra.sektoral.umumsektoral'=>function($query)
                                         {
                                          $query->where('umum_id', session('umum_atau_administrator_id'));
                                         }
                            ]
    ...
    // dd($tujuan);
      ...
      return view('view_supervisor_renstra.renstra_tujuansasaran')->with('periode', $periode)
                                                               // ->with('id', $id)
                                                              //  ->with('tujuan', $tujuan)
                                                                ->with('data', $data)
     ...
     public function createTujuansasaran()
    {
      ...
      $hal           = Hal::all();
      $periode       = Periode::all();
      $sektoral      = UmumSektoral::where('umum_id',session('umum_atau_administrator_id'))->get();

      $sasaran       = Renssasar::all();

      //dd($sektoral);

     return view('view_supervisor_renstra.renstra_tujuansasaran_add')->with('sasaran', $sasaran)
                                                                    ->with('bagian', $bagian)
                                                                    ->with('unsur', $unsur)
                                                                    //->with('hal', $hal)
   ...
   //   $data->save();
      ...
      return redirect()->route('supervisor.renstra.tujuansasaran')->with('success', 'PENAMBAHAN TUJUAN, SASARAN DAN TARGET SASARAN RENSTRA berhasil');
    }
...
//PENGEDITAN TUJUAN 
    public function editTujuansasaran(Request $req, $renstra_id, $tujuan_id)
    {
     ...
     return view('view_supervisor_renstra.renstra_tujuansasaran_edit')->with('data', $data)
                                                                    ->with('bagian', $bagian)
                                                                    ->with('unsur', $unsur)
                                                                    ->with('hal', $hal)
                                                                    ->with('periode', $periode)
...
//SIMPAN KE TABEL RENSTRA DENGAN ID(PRIMARY KEY) NYA AUTO INCREMENT
     ...
     //SIMPAN KE TABEL TUJUAN DENGAN ID(PRIMARY KEY) NYA AUTO INCREMENT
      ...
      $data_indikator->save();
        ...
        return redirect()->route('supervisor.renstra.tujuansasaran')
...
public function createSasaran($indikatortujuan_id)
    {
     ...
     return view('view_supervisor_renstra.renstra_sasaran_add')->with('bagian', $bagian)
                                                      ->with('unsur', $unsur)
                                                      ->with('hal', $hal)
...
//PENGEDITAN TUJUAN 
    public function editSasaran(Request $req, $indikatortujuan_id, $renssasar_id)
    {
     ...
     return view('view_supervisor_renstra.renstra_sasaran_edit')->with('data', $data)
                                                                    ->with('bagian', $bagian)
                                                                    ->with('unsur', $unsur)
                                                                    ->with('hal', $hal)
                                                                    ->with('periode', $periode)
   ...
   public function program(Request $req)
   {
      ...
      // }
       ...
       //                     )->get();
        ...
        $data_program = Tujuan::with(['renstra.sektoral.umumsektoral'=>function($query)
                                         {
                                          $query->where('umum_id', session('umum_atau_administrator_id'));
                                         }
                            ]
     ...
     // dd($program);
      ...
      return view('view_supervisor_renstra.renstra_program')->with('filter', $filter)
...
public function createProgram(Request $req, $id,$kemukiman_kode,$nama)
    {
     ...
     return view('view_supervisor_renstra.renstra_program_add')
                                                     ->with('id', $id)
   ...
   //   $data->save();
      ...
      return redirect()->route('supervisor.renstra.program')->with('success', 'PENAMBAHAN program RENSTRA berhasil');
    }
...
//PENGEDITAN REKAM MEDIK
    ...
    //  $data->pukul_konsultasi   = Carbon::parse($jurnalKonsultasi['waktu'])->format('H:i');
      ...
      return view('view_supervisor_renstra.renstra_program_edit')->with('data', $data)
                                                                ->with('indikatorrenssasar', $indikatorrenssasar)
                                                                ->with('unsur', $unsur)
    ...
    public function updateProgram(Request $req, $renssasarprog_id)
    {
     ...
     //SIMPAN KE TABEL KONSULTASI DENGAN ID(PRIMARY KEY) NYA AUTO INCREMENT
      ...
      $data->save();
        ...
        return redirect()->route('supervisor.renstra.program')
 ...
 public function deleteProgram(Request $req)
    {
     ...
     else
     {
      ...
      return redirect()->route('supervisor_renstra.program')
...
public function kegiatan(Request $req)
   {
      ...
      //dd($data);
       ...
       $renssasarprog = Renssasarprog::with(['indikatorrenssasar.renssasar.indikatortujuan.tujuan.renstra.sektoral.umumsektoral'=>function($query)
                                         {
                                          $query->where('umum_id', session('umum_atau_administrator_id'));
                                         }
                            ],
      ...
      return view('view_supervisor_renstra.renstra_kegiatan')->with('filter', $filter)
      ...
      public function createKegiatan($renssasarprog_id, $program_id, $program_kode, $program_nama)
    {
      ...
      // $kegiatan      = Dusun::where('gampong_id',1)->get();

      //dd($kegiatan);

     return view('view_supervisor_renstra.renstra_add')->with('renssasarprog_id', $renssasarprog_id)
   ...
   //   $data->save();
      ...
      return redirect()->route('supervisor.renstra.kegiatan')
  ...
  public function editKegiatan($renssasarprogkeg_id)
    ...
    //  $data->pukul_konsultasi   = Carbon::parse($jurnalKonsultasi['waktu'])->format('H:i');
      ...
      return view('view_supervisor_renstra.renstra_edit')->with('data', $data)
                                                       ->with('sasaran', $sasaran)
                                                       ->with('unsur', $unsur)
...
public function deleteKegiatan(Request $req)
    {
     ...
     if($data->jurnalKonsultasi->last()['status_konsultasi_id'] > 1)
     {
       return redirect()->route('supervisor_renstra.renstra')
    ...
    public function prosesDetail(Request $req, $konsultasi_id)
    {
     ...
     return redirect()->route('supervisor.renstra.terekap')
 ...
 public function setuju_opd(Request $req)
    {
...
//carilah semua KEGIATAN/GAMPONG YANG TELAH DIMASUKKAN KEDALAM RENSSASARPROGKEG YANG MANA UMUM_ID OPD nya adalah sama dengan session
      $data = Tujuan::with('indikatortujuan.renssasar.indikatorrenssasar.renssasarprog.indikatorrenssasarprog.renssasarprogkeg')->whereHas('renstra.sektoral.umumsektoral',
                                            function($query)
                                             {
                                              $query->where('umum_id', session('umum_atau_administrator_id'));
                                             }
    ...
    // }
      ...
      return view('view_supervisor_renstra.renstra_setujuopd')->with('filter', $filter)
                                              ->with('periode', $periode)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
    ...
    // }
      ...
      return view('view_supervisor_renstra.renstra_rekapitulasi')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
    ...
    // }
      ...
      return view('view_supervisor_renstra.renstra_setujubappeda')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
    ...
    { 
      ...
      return redirect()->route('supervisor.rekammedik.pending')
  ...
  //   }
     ...
     public function peprekomorbidan($id)
    {
      ...
      return view('view_supervisor_rekammedik.rekammedik_peprekomorbid')->with('data', $data)
                                                               // ->with('admins', $admins)
                                                               // ->with('ruang', $ruang)
 ...
 public function prosesPeprekomorbidan(Request $req, $id)
    ...
    public function prekomorbid(Request $req){
     ...
     if ($req->search) 
      ...
      return view('view_supervisor_rekammedik.rekammedik_prekomorbid')->with('filter', $filter)
                                                                 ->with('data', $data);
