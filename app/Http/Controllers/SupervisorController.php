...
//PROFIL KLINIK-------------------------------------------------------------------------------
    public function profil(Request $req)
    {
       ...
       // $data = $data->paginate(15);
        ...
        return view('view_supervisor_klinik.supervisor_profil')->with('data', $data);
                                                       //->with('filter', $filter);
    }
     ...
     public function manajemen(Request $req)
    {
       ...
       // $data = $data->paginate(15);
        ...
        return view('view_supervisor_klinik.supervisor_manajemen')->with('data', $data);
                                                       //->with('filter', $filter);
    }
    ...
    public function biodata(Request $req)
    {
     ...
     // }
      ...
      return view('view_supervisor_biodata.supervisor_data_edit')->with('data', $data)
    ...
    public function updateBiodata(Request $req, $id)
    {
        ...
        return redirect()->route('supervisor_biodata.supervisor_data', $id)
    ...
    public function deleteKaryawan(Request $req)
    {
      ...
      return redirect()->route('supervisor_biodata.supervisor_data')
    ...
    public function rekammedik(Request $req)
    {
      ...
      //                                  )->get();
       ...
       $data = Renssasarprogkegsubkeg::with(['item.jurnalKonsultasi'=>function($q)
                                                                      {
...
//dd(session('umum_atau_administrator_id'));
    ...
    //   $persentase=($totalrealisasi/$totalbelanja)x100;
     ...
     //  }
      ...
      return view('view_supervisor_rekammedik.supervisor_rm')->with('data', $data)
    ...
    { 
     ...
     return view('view_supervisor_rekammedik.supervisor_rm_add')->with('id', $id)
...
//dd($nama);
    ...
    //                 .str_pad(((int)$jml_konsultasi_hari_ini)+1,4,'0',STR_PAD_LEFT);
      ...
      return redirect()->route('supervisor_rekammedik.supervisor_rm')
    ...
    //   $persentase=($totalrealisasi/$totalbelanja)x100;
     ...
     //  }
      ...
      return view('view_supervisor_rekammedik.supervisor_rm_pending')->with('data', $data)
                                                         //->with('data_realisasi',$data_realisasi)
                                                          ->with('filter', $filter);
    }
...
public function rekammedik_tertolak(Request $req)
    ...
    //   $persentase=($totalrealisasi/$totalbelanja)x100;
     ...
     //  }
      ...
      return view('view_supervisor_rekammedik.supervisor_rm_tertolak')->with('data', $data)
                                                         //->with('data_realisasi',$data_realisasi)
                                                          ->with('filter', $filter);
    }
  ...
  //PENGEDITAN REKAM MEDIK
    ...
    //  $data->pukul_konsultasi   = Carbon::parse($jurnalKonsultasi['waktu'])->format('H:i');
      ...
      return view('view_supervisor_rekammedik.supervisor_rm_edit')->with('data', $data);
    }
    ...
    public function updateRM(Request $req, $id)
    {
       ...
       //                  ->delete();
        ...
        return redirect()->route('supervisor_rekammedik.supervisor_rm.edit', $id)
