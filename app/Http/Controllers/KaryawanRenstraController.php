...
class KaryawanRenstraController extends Controller
{
...
//carilah semua KEGIATAN/GAMPONG YANG TELAH DIMASUKKAN KEDALAM RENSSASARPROGKEG YANG MANA UMUM_ID OPD nya adalah sama dengan session
    ...
    // }
      ...
      return view('view_karyawan_renstra.renstra_setujuopd')->with('filter', $filter)
                                              ->with('periode', $periode)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
    ...
    // }
      ...
      return view('view_karyawan_renstra.renstra_rekapitulasi')->with('filter', $filter)
                                              // ->with('bagian', $bagian)
                                              // ->with('hal', $hal)
                                              // ->with('unsur', $unsur)
                                               ->with('data', $data);
